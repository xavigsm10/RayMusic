...
class InnerTube {
    ...
    var locale: YouTubeLocale = YouTubeLocale.fromSystem()
        set(value) {
            field = YouTubeLocale.sanitize(value.gl, value.hl)
        }
    ...
    /**
     * Retry wrapper for transient IO errors and 429/5xx status codes with exponential backoff.
     */
